...
const Body = () => {
  ...
  return (
    <>
    <h1 style={{textAlign:'center', color:"orange"}}>welcome,</h1>
   <h1 style={{textAlign:'center', color:"orange"}}>Organise your content with notex</h1>
    <div className='body d-flex flex-row flex-wrap' >
   
    {
      buckets[currentBucket].map(element=>{
        ...
        return <Player link={element[1]} key={i} load={load} setload={setload} video={element[2]} title={element[0]} index={i}></Player>
